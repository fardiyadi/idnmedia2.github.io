if(top!=self){
    window.frameElement.style = '-webkit-transition: all .5s linear 0s; -moz-transition: all .5s linear 0s;-ms-transition: all .5s linear 0s;-o-transition: all .5s linear 0s;transition: all .5s linear 0s; height: 400px; position: fixed; bottom: 0; left:0; right:0; margin:auto;';
}

$('#bottom_slide').animate({'height':'400px'},"slow");
