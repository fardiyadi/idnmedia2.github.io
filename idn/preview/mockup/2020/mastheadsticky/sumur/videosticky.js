...
$('#bottom_slide').animate({'height':'100px'},"slow");
$('.bs_ad').animate({'height':'0px'},"slow");
$('.bs_sticky').fadeIn('slow');
...
$('.bs_sticky').click(function() {
    ...
    document.getElementById("mastheadsticky").play();
...
$('.close_bs').click(function() {
    ...
    document.getElementById("mastheadsticky").pause();
    $('#bottom_slide').animate({'height':'100px'},"slow");
    $('.bs_sticky').animate({'height':'100px'},"slow");
    $('.bs_ad').fadeOut('slow');
});
