    ...
    $(document).ready(function () {
        ...
        $('.site').imagesLoaded(function () {
            ...
            $(window).scroll(function () {
                ...
                $('.top--section ._layer').each(function () {
                    var $layer = $(this);
            ...
            function fixTopHeight() {
                if (winWidth > 480) {
                    ...
                    var defaultView = 1440;
                    var currentView = $(window).width();
                    var currentHeight = defaultHeight / defaultView * currentView;

                    $('.top--section').height(currentHeight);
                    $('.top--section--base').height(currentHeight);
                } else {
                    var _defaultHeight = 360;
                    var defaultBgHeight = 408;
                    var _defaultView = 480;
                    var _currentView = $(window).width();
                    var _currentHeight = _defaultHeight / _defaultView * _currentView;
                    var currentBgHeight = defaultBgHeight / _defaultView * _currentView;

                    $('.top--section_background-inside').height(currentBgHeight);
                    $('.top--section').height(_currentHeight);
                    $('.top--section--base').height(_currentHeight);
                }
            }
            fixTopHeight();
