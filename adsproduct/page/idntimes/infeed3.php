    ...
    <?php include '../sidebar.php';?>
        ...
        <section id="bg-image" class="" style="padding-top: 50px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <img src="screenshots/idn-infeed-3.png" class="img-fluid">
                    </div>
                    <div class="col-md-5 spec-des">
                        ...
                        <a href="../../preview/desktop/idntimes/idntimes-infeed-3.html" target="_blank" class="preview">Go To Preview</a>
