    ...
    <?php include '../sidebar.php';?>
        ...
        <section id="bg-image" class="" style="padding-top: 50px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <img src="screenshots/idn-br-2.png" class="img-fluid">
                    </div>
                    <div class="col-md-5 spec-des">
                        <h1>Big Rectangle 2</h1>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                        <h3>Specification :</h3>
                        <ul>
                            <li>Width : 300 Pixel</li>
                            <li>Height : 600 Pixel</li>
                        ...
                        <a href="../../preview/desktop/idntimes/idntimes-br-2.html" target="_blank" class="preview">Go To Preview</a>
