    ...
    <?php include '../sidebar.php';?>
        ...
        <section id="bg-image" class="" style="padding-top: 50px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <img src="screenshots/popup.png" class="img-fluid">
                    </div>
                    <div class="col-md-5 spec-des">
                        ...
                        <h3>Specification :</h3>
                        <ul>
                            <li>Width : 600 Pixel</li>
                            <li>Height : 400 Pixel</li>
                            <li>Max Size : 100 KB</li>
                            <li>Duration : 15 Sec</li>
                        </ul>
                        ...
                        <a href="../../preview/desktop/idntimes/idntimes-popup.html" target="_blank" class="preview">Go To Preview</a>
