    ...
    <?php include '../sidebar.php';?>
        ...
        <section id="bg-image" class="" style="padding-top: 50px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <img src="screenshots/idn-mr-1.png" class="img-fluid">
                    </div>
                    <div class="col-md-5 spec-des">
                        <h1>Medium Rectangle 1</h1>
                        ...
                        <a href="../../preview/desktop/idntimes/idntimes-mr-1.html" target="_blank" class="preview">Go To Preview</a>
