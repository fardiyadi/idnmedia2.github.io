            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center mobile-ss">
                        <img src="screenshots/leaderboard-2.png" class="img-fluid">
                    </div>
                    <div class="col-md-6 spec-des">
                        <h1>Leaderboard V2</h1>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                        <h3>Specification :</h3>
                        <ul>
                            <li>Width : 300 Pixel</li>
                            <li>Height : 250 Pixel</li>
                        ...
                        <a href="../../preview/mobile/idntimes/leaderboard-2.html" target="_blank" class="preview">Go To Preview</a>
