            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center mobile-ss">
                        <img src="screenshots/parallax3.png" class="img-fluid">
                    </div>
                    <div class="col-md-6 spec-des">
                        ...
                        <h3>Specification :</h3>
                        <ul>
                            <li>Width : 640 Pixel</li>
                            <li>Height : 1280 Pixel</li>
                        ...
                        <a href="../../preview/mobile/idntimes/parallax3.html" target="_blank" class="preview">Go To Preview</a>
